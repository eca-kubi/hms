...
class CircularDoublyLinkedList {
    ...
    constructor() {
        ...
        /**
         * An object to store this.data with a custom user defined key for O(1) access
         * @property customDataStore
         * @type object
         */
     ...
     * @param {int} customKey A user defined key for storing data in this.customDataStore
    ...
    add(customKey, data) {
        ...
        this.customDataStore[customKey] = newNode;
        this.length++;
    ...
    /**
     * Get item from customDataStore using customKey, O(1) access
     * @param {any} customKey
     * @returns {CircularDoublyLinkedListNode}
     */
    getCustom(customKey) {
        return this.customDataStore[customKey];
    }
